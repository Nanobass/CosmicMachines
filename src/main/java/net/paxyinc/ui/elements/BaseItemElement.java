package net.paxyinc.ui.elements;
...
public class BaseItemElement extends BaseElement {
    ...
    public boolean shouldRenderBackground = true, shouldRenderAmount = true, shouldRenderName = true, shouldRenderHovered = true;
    ...
    public void drawBackground(UIRenderer renderer, Viewport viewport) {
        ...
        if(shouldRenderBackground) {
            if(isHoveredOver && shouldRenderHovered) hovered.render(uiRenderer, x, y);
